...
/**
* @file
* Definition of \Drupal\wmfootnotes\Plugin\CKEditorPlugin\Footnotes.
*/

namespace Drupal\wmfootnotes\Plugin\CKEditorPlugin;

use Drupal\ckeditor\CKEditorPluginBase;
use Drupal\editor\Entity\Editor;

/**
 * Defines the "Footnotes Button" plugin.
 *
 * @CKEditorPlugin(
 *   id = "footnotes",
...
class Footnotes extends CKEditorPluginBase {
    ...
    public function getButtons()
    {
        return [
          'footnotes' => [
            'label' => t('Footnotes'),
            'image' => drupal_get_path('module', 'wmfootnotes') . '/icons/footnotes.png'
          ]
        ];
    }
    ...
    {
        return drupal_get_path('module', 'wmfootnotes') . '/footnotes.plugin.js';
    }
